...
public class SecondActivity extends AppCompatActivity{
    ...
    private void setupViewPager(ViewPager viewPager, Bundle bundle)
    {
        ...
        adapter.addFragment(new ProfileFragment(bundle),"Shopping Lists");
        adapter.addFragment(new MatchesFragment(),"Allergies");
        adapter.addFragment(new SettingsFragment(),"Recipes");
